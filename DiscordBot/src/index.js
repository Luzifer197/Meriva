...
const { DISCORD_TOKEN, CLIENTSECRET, CLIENTID, BOTURL, APPID, PUBLICKEY, BOTURL} = require("../config");

const token = decryptToken(DISCORD_TOKEN);
const clientSecret = decryptToken(CLIENTSECRET);
const clientid = decryptToken(CLIENTID);
const botUrl = BOTURL;
const appid = decryptToken(APPID);
const publickey = decryptToken(PUBLICKEY);
